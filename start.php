...
function hj_forum_init() {
	...
	// Notification
    register_notification_object('object', 'hjforum', elgg_echo('hj:forum:newforum'));
    ...
    elgg_register_plugin_hook_handler('notify:entity:message', 'object', 'hj_forum_topic_notify_message');
