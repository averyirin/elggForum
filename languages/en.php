...
$english = array(
	...
	'edit:plugin:hypeforum:hint:forum_topic_river' => 'Add information about new forum topics to the activity stream',

	'edit:plugin:hypeforum:params[forum_post_river]' => 'Add new posts to river',
	'edit:plugin:hypeforum:hint:forum_post_river' => 'Add information about new forum posts to the activity stream',
    ...
    'hjforum:notification' =>
        "%s added a new forum: \r\n % \r\n %s \r\n View the forum at %s",
    
    'hjforumtopic:notification' =>
        "%s added a new forum topic: \r\n % \r\n %s \r\n View the topic at %s",
    
    'hjforumpost:notification' =>
        "%s added a new forum post: \r\n % \r\n %s \r\n View the post at %s",
);
